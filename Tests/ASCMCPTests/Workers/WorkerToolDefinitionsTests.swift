...
struct WorkerToolDefinitionsTests {
    ...
    func appsWorkerTools() async throws {
        ...
        #expect(names.contains("apps_list_search_keywords"))
    ...
    // MARK: - XcodeCloudWorker (42 tools)

    @Test("XcodeCloudWorker returns 42 tools with correct names")
    func xcodeCloudWorkerTools() async throws {
        let client = try await TestFactory.makeHTTPClient()
        let worker = XcodeCloudWorker(httpClient: client)
        let tools = await worker.getTools()
        #expect(tools.count == 42)
        let names = Set(tools.map(\.name))
        #expect(names.contains("xcode_cloud_products_list"))
        #expect(names.contains("xcode_cloud_products_get"))
        #expect(names.contains("xcode_cloud_products_delete"))
        #expect(names.contains("xcode_cloud_app_product_get"))
        #expect(names.contains("xcode_cloud_product_app_get"))
        #expect(names.contains("xcode_cloud_product_primary_repositories_list"))
        #expect(names.contains("xcode_cloud_product_additional_repositories_list"))
        ...
        #expect(names.contains("xcode_cloud_workflows_create"))
        #expect(names.contains("xcode_cloud_workflows_update"))
        #expect(names.contains("xcode_cloud_workflows_delete"))
        #expect(names.contains("xcode_cloud_workflow_repository_get"))
        ...
        #expect(names.contains("xcode_cloud_action_build_run_get"))
        ...
        #expect(names.contains("xcode_cloud_xcode_version_macos_versions_list"))
        #expect(names.contains("xcode_cloud_macos_versions_list"))
        #expect(names.contains("xcode_cloud_macos_versions_get"))
        #expect(names.contains("xcode_cloud_macos_version_xcode_versions_list"))
    ...
    // MARK: - ScreenshotsWorker (19 tools)

    @Test("ScreenshotsWorker returns 19 tools with correct names")
    ...
    // MARK: - CustomProductPagesWorker (17 tools)

    @Test("CustomProductPagesWorker returns 17 tools with correct names")
    func customProductPagesWorkerTools() async throws {
        ...
        #expect(names.contains("custom_pages_get_version"))
        #expect(names.contains("custom_pages_create_version"))
        #expect(names.contains("custom_pages_update_version"))
        #expect(names.contains("custom_pages_list_localizations"))
        #expect(names.contains("custom_pages_get_localization"))
        #expect(names.contains("custom_pages_create_localization"))
        #expect(names.contains("custom_pages_update_localization"))
        #expect(names.contains("custom_pages_delete_localization"))
        #expect(names.contains("custom_pages_list_search_keywords"))
        #expect(names.contains("custom_pages_add_search_keywords"))
        #expect(names.contains("custom_pages_remove_search_keywords"))
    }

    // MARK: - ProductPageOptimizationWorker (15 tools)

    @Test("ProductPageOptimizationWorker returns 15 tools with correct names")
    func productPageOptimizationWorkerTools() async throws {
        ...
        #expect(names.contains("ppo_list_version_experiments"))
        ...
        #expect(names.contains("ppo_get_treatment"))
        #expect(names.contains("ppo_create_treatment"))
        #expect(names.contains("ppo_update_treatment"))
        #expect(names.contains("ppo_delete_treatment"))
        #expect(names.contains("ppo_list_treatment_localizations"))
        #expect(names.contains("ppo_get_treatment_localization"))
        #expect(names.contains("ppo_create_treatment_localization"))
        #expect(names.contains("ppo_delete_treatment_localization"))
    }

    // MARK: - PromotedPurchasesWorker (10 tools)

    @Test("PromotedPurchasesWorker returns 10 tools with correct names")
    func promotedPurchasesWorkerTools() async throws {
        ...
        #expect(names.contains("promoted_reorder"))
